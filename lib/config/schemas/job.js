    ...
    return {
        ...
        operations: {
            ...
            format: function checkJobProcess(arr) {
                ...
                let connections = _.flatten(_.map(_.values(_.get(context.sysconfig, 'terafoundation.connectors', {})), _.keys));
                arr.forEach(function(op) {
                    let connectionDefined = false;
                    if (op.connection) {
            ...
            format: function(val) {
                if (val) {
                    if (typeof val === 'object') {
                        let configConnectors = _.get(context.sysconfig, 'terafoundation.connectors', {});
